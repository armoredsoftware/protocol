...
// JR - This header is for use with hotspot. Therefore, I removed all
// of the method definitions since those are linked to libpapi.so
// directly at runtime. This file is only needed for the macro defines
// and the structures used by PAPI.
...
#include <sys/types.h>
#include <limits.h>
#include "jr_custom_classes/papi_headers/papiStdEventDefs.h"
