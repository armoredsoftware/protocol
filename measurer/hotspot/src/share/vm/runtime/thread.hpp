...
//JG - Start Change
  virtual bool is_Talk_thread() const                { return false; }
//JG - End Change
...
public:
  ...
  //JG - Change Start
  std::string trace_stack2()                             PRODUCT_RETURN;
  std::string trace_stack_from2(vframe* start_vf)        PRODUCT_RETURN;
  std::string trace_stack3()                             PRODUCT_RETURN;
  std::string trace_stack_from3(vframe* start_vf)        PRODUCT_RETURN;
  //JG - Change End
  //JG - Start Change
  void var_trace_stack(int index, char* desired_frame, char* result)                         PRODUCT_RETURN;
  void var_trace_stack_from(vframe* start_vf, int index, char* desired_frame, char* result)    PRODUCT_RETURN;
  //JG - Change End
